...
public class StudentECE4 extends AppCompatActivity {

    ECEDatabaseHelper4 myeceDb4;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_ece4);
        myeceDb4 = new ECEDatabaseHelper4(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myeceDb4.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentECE4.this);
    ...
    public void update(View view) {
        Boolean updateData=myeceDb4.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
