...
public class StudentIT1 extends AppCompatActivity {
ITDatabaseHelper1 myitDb1;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_it1);
        myitDb1 = new ITDatabaseHelper1(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myitDb1.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentIT1.this);
    ...
    public void update(View view) {
        Boolean updateData=myitDb1.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
