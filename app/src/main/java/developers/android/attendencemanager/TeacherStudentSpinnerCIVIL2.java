...
public class TeacherStudentSpinnerCIVIL2 extends AppCompatActivity {
Toolbar toolbar;
    Spinner spnmode;
    TextView btnlogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_student_spinner_civil2);
        ...
        spnmode.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch(position){
                    case 1:
                        Intent intent1=new Intent(getApplicationContext(),StudentCIVIL2.class);
                        startActivity(intent1);
                        break;
                    case 2:
                        Intent intent2=new Intent(getApplicationContext(),TeacherCIVIL2.class);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherStudentSpinnerCIVIL2.this);
