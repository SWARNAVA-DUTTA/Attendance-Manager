...
public class TeacherCSE4 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_cse4);
    ...
    public void readbtn(View view) {
        Cursor res = mycseDb4.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=mycseDb4.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherCSE4.this);
