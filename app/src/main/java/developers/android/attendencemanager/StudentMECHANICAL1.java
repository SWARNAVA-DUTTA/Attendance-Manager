...
public class StudentMECHANICAL1 extends AppCompatActivity {

    MECHANICALDatabaseHelper1 mymechanicalDb1;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_mechanical1);
        mymechanicalDb1 = new MECHANICALDatabaseHelper1(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=mymechanicalDb1.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentMECHANICAL1.this);
    ...
    public void update(View view) {
        Boolean updateData=mymechanicalDb1.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
