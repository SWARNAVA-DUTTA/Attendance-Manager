...
public class StudentIT4 extends AppCompatActivity {

    ITDatabaseHelper4 myitDb4;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_it4);
        myitDb4 = new ITDatabaseHelper4(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myitDb4.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentIT4.this);
    ...
    public void update(View view) {
        Boolean updateData=myitDb4.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
