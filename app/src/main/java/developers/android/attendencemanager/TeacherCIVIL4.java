...
public class TeacherCIVIL4 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_civil4);
    ...
    public void readbtn(View view) {
        Cursor res = mycivilDb4.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=mycivilDb4.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherCIVIL4.this);
