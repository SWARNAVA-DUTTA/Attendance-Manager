...
public class StudentEE1 extends AppCompatActivity {

    EEDatabaseHelper1 myeeDb1;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_ee1);
        myeeDb1 = new EEDatabaseHelper1(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myeeDb1.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentEE1.this);
    ...
    public void update(View view) {
        Boolean updateData=myeeDb1.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
