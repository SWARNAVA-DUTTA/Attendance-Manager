...
public class TeacherEE3 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_ee3);
    ...
    public void deletebtn(View view) {
        int deletedata=myeeDb3.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherEE3.this);
