...
public class StudentEE2 extends AppCompatActivity {

    EEDatabaseHelper2 myeeDb2;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_ee2);
        myeeDb2 = new EEDatabaseHelper2(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myeeDb2.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentEE2.this);
    ...
    public void update(View view) {
        Boolean updateData=myeeDb2.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
