...
public class TeacherStudentSpinnerMECHANICAL3 extends AppCompatActivity {
Toolbar toolbar;
    Spinner spnmode;
    TextView btnlogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_student_spinner_mechanical3);
        ...
        spnmode.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch(position){
                    case 1:
                        Intent intent1=new Intent(getApplicationContext(),StudentMECHANICAL3.class);
                        startActivity(intent1);
                        break;
                    case 2:
                        Intent intent2=new Intent(getApplicationContext(),TeacherMECHANICAL3.class);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherStudentSpinnerMECHANICAL3.this);
