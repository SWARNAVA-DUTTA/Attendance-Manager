...
public class CIVILDatabaseHelper2 extends SQLiteOpenHelper {
    public final static String DATABASE_NAME = "Student.db18";
    public final static String TABLE_NAME = "student_table";
    public static final String COL_1 = "ROLL";
    public static final String COL_2 = "NAME";


    public CIVILDatabaseHelper2(Context context) {
