...
public class StudentEE3 extends AppCompatActivity {

    EEDatabaseHelper3 myeeDb3;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_ee3);
        myeeDb3 = new EEDatabaseHelper3(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myeeDb3.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentEE3.this);
    ...
    public void update(View view) {
        Boolean updateData=myeeDb3.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
