...
public class TeacherStudentSpinnerCIVIL1 extends AppCompatActivity {
...
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_student_spinner_civil1);
        ...
        spnmode.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch(position){
                    case 1:
                        Intent intent1=new Intent(getApplicationContext(),StudentCIVIL1.class);
                        startActivity(intent1);
                        break;
                    case 2:
                        Intent intent2=new Intent(getApplicationContext(),TeacherCIVIL1.class);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherStudentSpinnerCIVIL1.this);
