...
public class TeacherECE4 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_ece4);
    ...
    public void readbtn(View view) {
        Cursor res = myeceDb4.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=myeceDb4.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherECE4.this);
