...
public class TeacherCSE3 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_cse3);
    ...
    public void readbtn(View view) {
        Cursor res = mycseDb3.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=mycseDb3.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherCSE3.this);
