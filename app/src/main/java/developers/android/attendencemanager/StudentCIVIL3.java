...
public class StudentCIVIL3 extends AppCompatActivity {

    CIVILDatabaseHelper3 mycivilDb3;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_civil3);
        mycivilDb3 = new CIVILDatabaseHelper3(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=mycivilDb3.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentCIVIL3.this);
    ...
    public void update(View view) {
        Boolean updateData=mycivilDb3.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
