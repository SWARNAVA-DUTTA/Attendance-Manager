...
public class StudentECE2 extends AppCompatActivity {

    ECEDatabaseHelper2 myeceDb2;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_ece2);
        myeceDb2 = new ECEDatabaseHelper2(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myeceDb2.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentECE2.this);
    ...
    public void update(View view) {
        Boolean updateData=myeceDb2.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
