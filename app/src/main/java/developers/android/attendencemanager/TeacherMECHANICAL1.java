...
public class TeacherMECHANICAL1 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_mechanical1);
    ...
    public void readbtn(View view) {
        Cursor res = mymechanicalDb1.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=mymechanicalDb1.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherMECHANICAL1.this);
