...
public class TeacherStudentSpinnerMECHANICAL2 extends AppCompatActivity {
Toolbar toolbar;
    Spinner spnmode;
    TextView btnlogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_student_spinner_mechanical2);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch(position){
                    case 1:
                        ...
                        break;
                    case 2:
                        Intent intent2=new Intent(getApplicationContext(),TeacherMECHANICAL2.class);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherStudentSpinnerMECHANICAL2.this);
