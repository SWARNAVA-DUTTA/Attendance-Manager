...
public class TeacherCIVIL2 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_civil2);
    ...
    public void readbtn(View view) {
        Cursor res = mycivilDb2.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=mycivilDb2.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherCIVIL2.this);
