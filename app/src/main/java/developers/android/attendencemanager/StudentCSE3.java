...
public class StudentCSE3 extends AppCompatActivity {

    CSEDatabaseHelper3 mycseDb3;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mycseDb3 = new CSEDatabaseHelper3(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=mycseDb3.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentCSE3.this);
    ...
    public void update(View view) {
        Boolean updateData=mycseDb3.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
