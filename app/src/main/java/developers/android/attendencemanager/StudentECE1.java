...
public class StudentECE1 extends AppCompatActivity {

    ECEDatabaseHelper1 myeceDb1;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_ece1);
        myeceDb1 = new ECEDatabaseHelper1(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myeceDb1.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentECE1.this);
    ...
    public void update(View view) {
        Boolean updateData=myeceDb1.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
