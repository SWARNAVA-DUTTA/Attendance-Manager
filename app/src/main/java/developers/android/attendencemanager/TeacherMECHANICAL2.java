...
public class TeacherMECHANICAL2 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_mechanical2);
    ...
    public void readbtn(View view) {
        Cursor res = mymechanicalDb2.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=mymechanicalDb2.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherMECHANICAL2.this);
