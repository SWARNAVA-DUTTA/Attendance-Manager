...
public class StudentIT2 extends AppCompatActivity {

    ITDatabaseHelper2 myitDb2;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_it2);
        myitDb2 = new ITDatabaseHelper2(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myitDb2.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentIT2.this);
    ...
    public void update(View view) {
        Boolean updateData=myitDb2.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
