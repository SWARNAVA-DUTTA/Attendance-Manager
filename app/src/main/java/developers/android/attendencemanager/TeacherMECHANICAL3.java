...
public class TeacherMECHANICAL3 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_mechanical3);
    ...
    public void readbtn(View view) {
        Cursor res = mymechanicalDb3.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=mymechanicalDb3.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherMECHANICAL3.this);
