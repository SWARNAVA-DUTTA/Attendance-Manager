...
public class TeacherECE3 extends AppCompatActivity {
...
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_ece3);
    ...
    public void readbtn(View view) {
        Cursor res = myeceDb3.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=myeceDb3.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherECE3.this);
