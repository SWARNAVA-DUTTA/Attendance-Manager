...
public class StudentMECHANICAL2 extends AppCompatActivity {

    MECHANICALDatabaseHelper2 mymechanicalDb2;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_mechanical2);
        mymechanicalDb2 = new MECHANICALDatabaseHelper2(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=mymechanicalDb2.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentMECHANICAL2.this);
    ...
    public void update(View view) {
        Boolean updateData=mymechanicalDb2.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
