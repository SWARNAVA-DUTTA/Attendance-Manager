...
public class StudentEE4 extends AppCompatActivity {

    EEDatabaseHelper4 myeeDb4;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_ee4);
        myeeDb4 = new EEDatabaseHelper4(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myeeDb4.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentEE4.this);
    ...
    public void update(View view) {
        Boolean updateData=myeeDb4.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
