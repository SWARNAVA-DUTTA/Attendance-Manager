...
public class TeacherIT4 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_it4);
    ...
    public void deletebtn(View view) {
        int deletedata=myitDb4.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherIT4.this);
