...
public class StudentCSE2 extends AppCompatActivity {
...
Toolbar toolbar;
    ...
    public void submitbtn(View v) {
        boolean isInserted=mycseDb2.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentCSE2.this);
    ...
    public void update(View view) {
        Boolean updateData=mycseDb2.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
