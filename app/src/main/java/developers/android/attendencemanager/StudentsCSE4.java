...
public class StudentsCSE4 extends AppCompatActivity {

    CSEDatabaseHelper4 mycseDb4;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_students_cse4);
        mycseDb4 = new CSEDatabaseHelper4(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=mycseDb4.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentsCSE4.this);
    ...
    public void update(View view) {
        Boolean updateData=mycseDb4.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
