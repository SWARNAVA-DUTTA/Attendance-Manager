...
public class StudentMECHANICAL3 extends AppCompatActivity {

    MECHANICALDatabaseHelper3 mymechanicalDb3;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_mechanical3);
        mymechanicalDb3 = new MECHANICALDatabaseHelper3(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=mymechanicalDb3.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentMECHANICAL3.this);
    ...
    public void update(View view) {
        Boolean updateData=mymechanicalDb3.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
