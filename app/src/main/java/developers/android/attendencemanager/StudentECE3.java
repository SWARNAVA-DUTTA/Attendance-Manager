...
public class StudentECE3 extends AppCompatActivity {

    ECEDatabaseHelper3 myeceDb3;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_ece3);
        myeceDb3 = new ECEDatabaseHelper3(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myeceDb3.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentECE3.this);
    ...
    public void update(View view) {
        Boolean updateData=myeceDb3.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
