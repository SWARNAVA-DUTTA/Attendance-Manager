...
public class StudentMECHANICAL4 extends AppCompatActivity {
...
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_mechanical4);
    ...
    public void submitbtn(View v) {
        boolean isInserted=mymechanicalDb4.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentMECHANICAL4.this);
    ...
    public void update(View view) {
        Boolean updateData=mymechanicalDb4.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
