...
public class TeacherCIVIL3 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_civil3);
    ...
    public void readbtn(View view) {
        Cursor res = mycivilDb3.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=mycivilDb3.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherCIVIL3.this);
