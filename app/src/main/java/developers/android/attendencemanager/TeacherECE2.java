...
public class TeacherECE2 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_ece2);
    ...
    public void readbtn(View view) {
        Cursor res = myeceDb2.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=myeceDb2.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherECE2.this);
