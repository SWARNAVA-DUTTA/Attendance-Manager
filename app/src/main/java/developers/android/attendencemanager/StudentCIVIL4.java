...
public class StudentCIVIL4 extends AppCompatActivity {

    CIVILDatabaseHelper4 mycivilDb4;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_civil4);
        mycivilDb4 = new CIVILDatabaseHelper4(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=mycivilDb4.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentCIVIL4.this);

        mBuilder.setTitle("Thank You"+idname);
    ...
    public void update(View view) {
        Boolean updateData=mycivilDb4.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
