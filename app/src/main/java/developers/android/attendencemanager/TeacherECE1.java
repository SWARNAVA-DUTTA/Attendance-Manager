...
public class TeacherECE1 extends AppCompatActivity {
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_ece1);
    ...
    public void readbtn(View view) {
        Cursor res = myeceDb1.getAllData();
    ...
    public void deletebtn(View view) {
        int deletedata=myeceDb1.deleteData(null,null);
    ...
    public void showDialoglogout(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(TeacherECE1.this);
