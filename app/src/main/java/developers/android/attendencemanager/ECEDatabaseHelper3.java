...
public class ECEDatabaseHelper3 extends SQLiteOpenHelper {
    public final static String DATABASE_NAME = "Student.db11";
    public final static String TABLE_NAME = "student_table";
    public static final String COL_1 = "ROLL";
    public static final String COL_2 = "NAME";


    public ECEDatabaseHelper3(Context context) {
