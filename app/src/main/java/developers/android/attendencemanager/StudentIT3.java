...
public class StudentIT3 extends AppCompatActivity {

    ITDatabaseHelper3 myitDb3;
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_it3);
        myitDb3 = new ITDatabaseHelper3(this);
    ...
    public void submitbtn(View v) {
        boolean isInserted=myitDb3.insertData(idroll.getText().toString(),idname.getText().toString());
    ...
    public void showDialog(){
        AlertDialog.Builder mBuilder=new AlertDialog.Builder(StudentIT3.this);
    ...
    public void update(View view) {
        Boolean updateData=myitDb3.updateData(idroll.getText().toString(),idname.getText().toString());
        if((idroll.getText().toString().equals("")) && idname.getText().toString().equals("")){
            idroll.setError("Please enter the following field");
            idname.setError("Please enter the following field");
            idroll.requestFocus();}
